...
inline constexpr int slotParameterValueCount=286;
...
inline constexpr int slotDelayDryParameterIndex=276;
inline constexpr int slotDelayWetParameterIndex=277;
inline constexpr int slotDelayVolumeParameterIndex=278;
inline constexpr int slotDelayDivisionParameterIndex=279;
inline constexpr int slotDelayFeedbackParameterIndex=280;
inline constexpr int slotDelayGlideParameterIndex=281;
inline constexpr int slotDelayFilterParameterIndex=282;
inline constexpr int slotDelayLeftOffsetParameterIndex=283;
inline constexpr int slotDelayRightOffsetParameterIndex=284;
inline constexpr int slotDelayFilterResonanceParameterIndex=285;
