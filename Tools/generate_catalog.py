...
# Per-Slot parameters that are native to the VST3 architecture rather than
# legacy JSFX sliders. Keep these appended after the 14 routing descriptors so
# SlotArchitecture.h indices remain stable.
UNIVERSAL_SLOT_PARAMETERS = [
    ...
    (266, "slotDelayDivision", "Delay Time", 0.0, 11.0, 1.0, 4.0,
     "4 Bars|3 Bars|2 Bars|1 Bar|1/8|1/16|1/32|1/64|1/128|1/256|1/512|1/1024"),
...
def generate_parameters(parameters: list[dict[str, str]]) -> None:
    ...
    for number, parameter_id, name, minimum, maximum, step, default, choices in UNIVERSAL_SLOT_PARAMETERS:
        rows.append(
